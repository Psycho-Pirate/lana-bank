...
export const mockCreditFacilityObligationInstallment = (overrides?: Partial<CreditFacilityObligationInstallment>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CreditFacilityObligationInstallment' } & CreditFacilityObligationInstallment => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CreditFacilityObligationInstallment');
    return {
...
export const mockCreditFacilityPartialPaymentWithDateInput = (overrides?: Partial<CreditFacilityPartialPaymentWithDateInput>, _relationshipsToOmit: Set<string> = new Set()): CreditFacilityPartialPaymentWithDateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CreditFacilityPartialPaymentWithDateInput');
    return {
        amount: overrides && overrides.hasOwnProperty('amount') ? overrides.amount! : generateMockValue.usdCents(),
        creditFacilityId: overrides && overrides.hasOwnProperty('creditFacilityId') ? overrides.creditFacilityId! : generateMockValue.uuid(),
        effective: overrides && overrides.hasOwnProperty('effective') ? overrides.effective! : faker.date.past({ years: 1, refDate: new Date(2022, 0) }).toISOString(),
...
export const mockMutation = (overrides?: Partial<Mutation>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Mutation' } & Mutation => {
    ...
    return {
        ...
        creditFacilityPartialPaymentWithDate: overrides && overrides.hasOwnProperty('creditFacilityPartialPaymentWithDate') ? overrides.creditFacilityPartialPaymentWithDate! : relationshipsToOmit.has('CreditFacilityPartialPaymentPayload') ? {} as CreditFacilityPartialPaymentPayload : mockCreditFacilityPartialPaymentPayload({}, relationshipsToOmit),
...
export const mockPaymentEntry = (overrides?: Partial<PaymentEntry>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'PaymentEntry' } & PaymentEntry => {
    ...
    return {
        ...
        payment: overrides && overrides.hasOwnProperty('payment') ? overrides.payment! : relationshipsToOmit.has('CreditFacilityObligationInstallment') ? {} as CreditFacilityObligationInstallment : mockCreditFacilityObligationInstallment({}, relationshipsToOmit),
        recordedAt: overrides && overrides.hasOwnProperty('recordedAt') ? overrides.recordedAt! : generateMockValue.timestamp(),
    };
};
